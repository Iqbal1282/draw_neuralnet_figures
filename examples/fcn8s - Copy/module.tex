...
%% Draw Layer Blocks
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\node[canvas is zy plane at x=0] (temp) at (0,0,0) {\includegraphics[width=8cm,height=8cm]{mask_0.jpg}};



%\pic[shift={(5,0,0)}] at (temp) {Ball={name=dot1,fill=\edgecolor,radius=2.5,logo=$.$}};
\pic[shift={(5,0)}] at (temp) {Ball={name=dot1,fill={rgb:white, 5},radius=2.5,logo=$\cdot$}};


\pic[shift={(10,0,0)}] at (temp) {Box={name=f1,%
...
\pic[shift={(.9,0,0)}] at (f1-west) {Box={name=f4,%
        caption=,zlabel=,fill=\RedColor,
        height=35,width={0.2},depth=35}};
\node[text width=20cm, align=center,font=\Huge\sffamily, shift={(0,-2.5,0)}] at (f2-south) {Feature Map};
...
\pic[shift={(.9,0,0)}] at (m1-west) {Box={name=m4,%
        ...
        height=35,width={0.2},depth=35}};
\node[text width=20cm, align=center,font=\Huge\sffamily, shift={(0,-2.5,0)}] at (m2-south) {Masked Feature Map};
...
\pic[shift={(-5,0,0)}] at (temp) {Box={name=block1,caption=(a),%
        fill=\PoolColor,opacity=0,height=68,width=200,depth=0,font=\Huge,}};
...
\pic[shift={(5,0,0)}] at (GMP1-east) {Box={name=GMP1a,%
        caption=Conv 3x3,zlabel=,fill=\ConvColor,font=\Huge,
...
\pic[shift={(.9,0,0)}] at (tf-west) {Box={name=tf3,%
        caption=,zlabel=,fill=\BlueColor,font=\Huge,
        height=35,width={0.2},depth=35}};
\node[text width=20cm, align=center,font=\Huge\sffamily, shift={(0.5,-2.5,0)}] at (tf1-south) {Masked Feature Map};
...
\node[text width=20cm, align=center,font=\Huge\sffamily, shift={(0,-2.5,0)}] at (bm1-south) {Feature Map};
...
\pic[shift={(.9,0,0)}] at (lf-west) {Box={name=lf3,%
        caption=,zlabel=,fill=\BlueColor,font=\Huge,
        height=35,width={0.2},depth=35}};
\node[text width=20cm, align=center,font=\Huge\sffamily, shift={(0,-2.5,0)}] at (lf1-south) {Masked Feature Map};
...
\pic[shift={(.9,0,0)}] at (lm-west) {Box={name=lm3,%
        caption=,zlabel=,fill=\RedColor,font=\Huge,
        height=35,width={0.2},depth=35}};
\node[text width=20cm, align=center,font=\Huge\sffamily, shift={(0,-2.5,0)}] at (lm1-south) {Feature Map};
...
\pic[shift={(-45,-1.5,0)}] at (lfc-west) {Box={name=block3,%
        caption=(c),zlabel=,fill=\RedColor,font=\Huge,opacity=0, 
        height=122,width={246},depth=0}};
